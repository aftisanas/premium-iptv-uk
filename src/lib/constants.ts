...
export const FEATURES = [
  ...
  {
    title: "30-Day Refund Window — More Than Twice The UK Legal Minimum",
    description:
      "Every premium IPTV plan carries a 30-day refund window, double the 14-day statutory minimum for distance-sold digital services. Requested via email or WhatsApp, no questions asked.",
...
export const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      "Optional Secure Proxy add-on available at checkout",
  ...
  },
  {
    ...
    name: "12 Months",
    months: 12,
    subtitle: "A full year of premium IPTV UK at £4.17/month",
    price: 49.99,
    originalPrice: 99.99,
    perMonth: 4.17,
    period: "year",
