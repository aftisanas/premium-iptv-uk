        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 py-16 lg:max-w-5xl lg:mx-auto">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-muted leading-relaxed mb-6">
              The premium IPTV UK service British households trust. 37,000 live channels, 198,000 films and series, 4K UHD and 24/7 UK support — from £4.17/month on the 12-month term.
            </p>
